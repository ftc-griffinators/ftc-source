...
public class BlueSampleAuto extends LinearOpMode
{
    ...
    public static Pose2d rightSampleZone = new Pose2d(18.196714000801663, 15.131687641769346,
            -0.087);
    public static Pose2d midSampleZone = new Pose2d(17.537188152180427, 23.65763929740031, -0.087);
    public static Pose2d leftSampleZone = new Pose2d(18.81505947359435, 25.276865707856548,
            0.4383081603154254);
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Action boxToBarScore =
                drive.actionBuilder(boxScoringPose).strafeTo(new Vector2d(bar.position.x,
                        bar.position.y)).build();
