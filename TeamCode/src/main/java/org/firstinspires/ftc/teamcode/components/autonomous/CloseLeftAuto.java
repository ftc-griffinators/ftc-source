    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Action moveToRightPixelPos =
                drive.actionBuilder(drive.pose)
                        .splineTo(
                                drive.pose.position.plus(
                                        new Vector2d(params._2splineRightX, params._2splineRightY)),
                                params._2splineRightRot)
                        .build();
        ...
        Action moveToLeftPixelPos =
                drive.actionBuilder(drive.pose)
                        .strafeTo(
                                drive.pose.position.plus(
                                        new Vector2d(params._2strafeLeftX, params._2strafeLeftY)))
                        .build();
        ...
        Action moveToBoard =
                drive.actionBuilder(
                        ...
                        //                .splineToConstantHeading(drive.pose.position.plus(new
                        // Vector2d(params._3splineMiddleX, params._3splineMiddleY)),
                        // params._3splineMiddleRot)
                        //                .strafeTo(drive.pose.position.plus(new
                        // Vector2d(params._3splineMiddleX + 42, params._3splineMiddleY)))
