...
import org.firstinspires.ftc.teamcode.messages.commands.TankCommandMessage;
import org.firstinspires.ftc.teamcode.messages.inputs.TankLocalizerInputsMessage;
...
public final class TankDrive
{
    ...
    public class DriveLocalizer implements Localizer
    {
        ...
        public Twist2dDual<Time> update()
        {
            ...
            TankKinematics.WheelIncrements<Time> twist = new TankKinematics.WheelIncrements<>(new DualNum<Time>(new double[]{
                    meanLeftPos - lastLeftPos,
                    meanLeftVel}).times(PARAMS.inPerTick), new DualNum<Time>(new double[]{
                    meanRightPos - lastRightPos, meanRightVel,}).times(PARAMS.inPerTick));
    ...
    public final class FollowTrajectoryAction implements Action
    {
        ...
        public boolean run(@NonNull TelemetryPacket p)
        {
            ...
            PoseVelocity2dDual<Time> command = new RamseteController(kinematics.trackWidth, PARAMS.ramseteZeta, PARAMS.ramseteBBar).compute(x, txWorldTarget, pose);
