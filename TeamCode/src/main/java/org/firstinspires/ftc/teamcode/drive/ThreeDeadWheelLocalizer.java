...
import org.firstinspires.ftc.teamcode.messages.inputs.ThreeDeadWheelInputsMessage;
    ...
    public Twist2dDual<Time> update()
    {
        ...
        Twist2dDual<Time> twist = new Twist2dDual<>(new Vector2dDual<>(new DualNum<Time>(new double[]{
                ...
                (PARAMS.par0YTicks - PARAMS.par1YTicks), (PARAMS.par0YTicks * par1PosVel.velocity -
                                                         ...
                                                         (PARAMS.par0YTicks -
                                                          PARAMS.par1YTicks),}).times(inPerTick), new DualNum<Time>(new double[]{
                ...
                (PARAMS.perpXTicks / (PARAMS.par0YTicks - PARAMS.par1YTicks) *
                 ...
                 perpPosVel.velocity),}).times(inPerTick)), new DualNum<>(new double[]{
