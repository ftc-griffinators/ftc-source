...
public class TeleOp_Ken extends LinearOpMode {
    ...
    private void clawArmAngle(double initClawAngle, boolean ground) {
        if (ground) {
            ...
            // clawControl.setPosition(initClawAngle - 0.21 +
            // ((double)(armControlLeft.getCurrentPosition()+armControlRight.getCurrentPosition()))*9/40000); // claw pos when in air (0.2 because 60 degrees)
        }
    }
