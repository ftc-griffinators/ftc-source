...
public final class Claw
{
    ...
    public void controlRotation(CLAW_ROTATION rotation)
    {
        ...
        {
            case DETECTION:
                clawControl.setPosition(PARAMS.CLAW_CONTROL_DETECTION_POSITION);
                break;
            case GROUND:
                clawControl.setPosition(PARAMS.CLAW_CONTROL_GROUND_POS);
                break;
            case HIDDEN:
                clawControl.setPosition(PARAMS.CLAW_CONTROL_CLOSED_POS);
                break;
            case BOARD:
