...
import org.firstinspires.ftc.teamcode.systems.interfaces.Localizer;
...
public final class ThreeDeadWheelLocalizer implements Localizer
{
    ...
    public Twist2dDual<Time> update()
    {
        ...
        if (!initialized)
        {
            ...
            // Test
            int beginningPosPar1 = lastPar1Pos;
            int beginningPosPerp = lastPerpPos;
    ...
    {
        public double par0YTicks =
                -2621.144848271604; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =
                2519.0743034289853; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =
                -2112.6321408413237; // x position of the perpendicular encoder (in tick units)
    }
}